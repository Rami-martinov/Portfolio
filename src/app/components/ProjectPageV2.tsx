...
export interface ProjectStatV2 {
  category: string;
  result: string;
}

export interface ProjectPillarV2 {
  name: string;
  description: string;
}
...
export function ProjectPageV2({ project }: { project: ProjectDataV2 }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fff" }}>
      ...
      {/* ── Overview image — bleed: blue top half, white bottom half ── */}
      <div style={{ background: "linear-gradient(to bottom, #1B72E8 50%, #fff 50%)" }}>
        <div className="max-w-[1440px] mx-auto box-border px-4 sm:px-8 md:px-[72px]">
          <img
            ...
            style={{ width: "100%", display: "block", boxShadow: "0 8px 40px rgba(0,0,0,0.12)", borderRadius: 16, cursor: "zoom-in" }}
            onClick={() => open([project.overviewImage])}
          />
        </div>
      </div>
      ...
      <div className="max-w-[1440px] mx-auto box-border px-4 sm:px-8 md:px-[72px]">
        ...
        {project.statsIntro && (
          <FadeInSection>
            <p
              className="pt-16 md:pt-32 md:px-[184px]"
              style={{
                fontFamily: "'Inter', sans-serif",
            ...
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-10">
              {project.stats.map((stat, i) => (
                <div key={i} style={CARD_STYLE}>
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 16, color: "#616161", margin: 0 }}>
                    {stat.category}
                  </p>
                  <hr style={{ border: "none", borderTop: "1px solid #e6e9ec", margin: 0 }} />
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 20, fontWeight: 700, lineHeight: 1.35, color: "#212121", margin: 0 }}>
                    {stat.result}
                  </p>
                </div>
              ))}
        ...
        <FadeInSection>
          <div className="pt-16 md:pt-32">
            <img
              ...
              alt="Challenge"
              style={{ width: "100%", display: "block", boxShadow: "0 8px 40px rgba(0,0,0,0.12)", borderRadius: 16, cursor: "zoom-in" }}
              onClick={() => open([project.challengeImage])}
            />
          </div>
        </FadeInSection>
        ...
        <FadeInSection>
          <div className="pt-16 md:pt-32">
            <img
              ...
              alt="Solution"
              style={{ width: "100%", display: "block", boxShadow: "0 8px 40px rgba(0,0,0,0.12)", borderRadius: 16, cursor: "zoom-in" }}
              onClick={() => open([project.solutionImage])}
            />
          </div>
        </FadeInSection>
        ...
        <FadeInSection>
          <p
            className="pt-16 md:pt-32 md:px-[184px]"
            style={{ fontFamily: "'Inter', sans-serif", fontSize: "clamp(1rem, 1.3vw, 1.25rem)", fontWeight: 500, lineHeight: 1.35, color: "#010101", letterSpacing: "0.1px", margin: 0 }}
          >
        ...
        {project.closingText && (
          <FadeInSection>
            <p
              className="pt-16 md:pt-32 pb-16 md:pb-32 md:px-[184px]"
              style={{
                fontFamily: "'Inter', sans-serif",
                fontSize: "clamp(1rem, 1.3vw, 1.25rem)",
                fontWeight: 500,
      ...
      <div style={{ background: "linear-gradient(135deg, #374151 0%, #1f2937 100%)" }}>
        <div className="max-w-[1440px] mx-auto box-border px-6 md:px-[72px] py-16 md:py-32 flex flex-col sm:flex-row items-center justify-between gap-10">
          ...
          {prev ? (
            <a
              href={prev.path}
              style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", textDecoration: "none", flexShrink: 0 }}
            >
              <span style={{ fontFamily: "'Inter', sans-serif", fontSize: 11, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(255,255,255,0.4)", marginBottom: 4 }}>
                Previous project
              </span>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 12, textAlign: "center" }}>
            ...
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 18, fontWeight: 600, color: "white", margin: 0, whiteSpace: "nowrap" }}>
          ...
          {next ? (
            <a
              href={next.path}
              style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", textDecoration: "none", flexShrink: 0 }}
            >
              <span style={{ fontFamily: "'Inter', sans-serif", fontSize: 11, letterSpacing: "0.18em", textTransform: "uppercase", color: "rgba(255,255,255,0.4)", marginBottom: 4 }}>
                Next project
              </span>
